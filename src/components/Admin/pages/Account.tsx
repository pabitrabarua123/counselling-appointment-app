    ...
    <>
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
       <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {"*".repeat(session?.user?.password?.length || 0)}
              </p>
            </div>
        ...
        <button
          onClick={openModal}
          className="cursor-pointer flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 lg:inline-flex lg:w-auto"
        >
          <svg
            ...
            <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
              <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                ...
                <form className="flex flex-col">
                  ...
                  { success && (
                    <p className="mt-4 text-sm text-green-600">Profile updated successfully! <Link href="/auth/signin" className="text-blue-500 hover:underline">
                      Login
                    </Link></p>
                  )}
                </form>
