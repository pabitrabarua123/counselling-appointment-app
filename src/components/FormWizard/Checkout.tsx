  ...
  return (
    ...
    <div>
      ...
      <p className="text-gray-600 leading-relaxed mb-6">
        ...
        therapist, and timing. Review the summary and proceed to secure
      ...
      <div className="space-y-4 text-sm text-gray-700">
        <div className="flex items-start gap-3">
          ...
          <p>Licensed therapist session</p>
        </div>

        <div className="flex items-start gap-3">
          <span className="text-green-600 text-lg">✔</span>
          <p>Private & confidential conversation</p>
        </div>
    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
      ...
      <button
        className={`mt-6 w-full bg-primary cursor-pointer hover:bg-secondary text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2 shadow-md ${
      ...
      <p className="text-xs text-gray-500 text-center mt-4 flex justify-center gap-1 items-center">
